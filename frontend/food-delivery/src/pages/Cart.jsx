...
const {products, navigate, cartCount,cartItems,
   totalCartAmount,removeFromCart,addToCart,updateCartItem,axios,user,
...
const placeOrder=async()=>{
  try{
if(!selectedAddress){
    return toast.error("plese select address");
}
                        ...
                        <div className="flex items-center md:gap-6 gap-3">
                            <div onClick={()=>{
                              ...
                              scrollTo(0,0);
                                ...
                                src={`http://localhost:3001/images/${product.image[0]}`} alt={product.name} />
                            </div>
                            <div>
